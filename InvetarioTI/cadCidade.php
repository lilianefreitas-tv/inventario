<?php
	...
	if (isset($_POST['submit']))
	{
		...
		$id_local = $_POST['id_cidade'];
		$descricao = $_POST['descricao'];
		
			
		$result = mysqli_query($conexao, "INSERT INTO cidade (id_cidade,descricao) VALUES (null,'{$descricao}')");
	...
	<body class="bg-light">
        ...
        <div class=" container col-md-6 order-md-1" >
			<div class="py-3 text-left">
				<form class="needs-validation" novalidate action="cadCidade.php" method="POST" >
					<div class="row">
