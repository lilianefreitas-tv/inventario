...
<html lang="pt-br">
  <head>
    ...
    <title>Inventário de TI MPPA</title>
  </head>
  <body>
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby ="dropdownconsulta">
							<a class="dropdown-item" href="ConsultaInventario.php">Consulta  de Inventário</a>
							<a class="dropdown-item" href="ConsultaBaixados.php">Consulta  de Baixa de Patrimônios</a>
							<a class="dropdown-item" href="relatorios.php">Relatórios</a>
							<a class="dropdown-item" href="ConsultaUsuario.php">Usuários</a>
							<hr class="mb-2">
							<a class="dropdown-item" href="Consulta.php">Cadastros Auxiliares</a>
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdown01">
							...
							<a class="dropdown-item" href="cadTipo.php">Tipo de Material</a>
							<a class="dropdown-item" href="cadMarca.php">Marca</a>
							<a class="dropdown-item" href="cadCidade.php">Cidade</a>
							<a class="dropdown-item" href="cadLocalizacao.php">Localização</a>
						</div>
					</li>
				</ul>
			</div>
