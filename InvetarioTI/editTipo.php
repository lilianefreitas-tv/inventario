	...
	<body class="bg-light">
		<div class="container">
			<div class="py-4 text-center">
				<br> <br>
				<h2>Edição de Tipos de Material</h2>
			</div>
		</div>
		<div class=" container col-md-6 order-md-1">
			<div class="py-3 text-left">
				<form class="needs-validation" novalidate action="saveEditTipo.php" method="POST" >
					<div class="row">
						<div class="col-md-2 mb-3">
							<label for="codigo">Código</label>
							<input type="text" class="form-control" name= "codigo" id="codigo" placeholder="" value="<?php echo $id_tipo ?>" required readonly>
							
						</div>
						<div class="col-md-10 mb-3">
							<label for="descricao">Descrição do Material</label>
							<input type="text" class="form-control" name= "descricao" id="descricao" placeholder="" value="<?php echo $descricao ?>" required >
					...
					<input class="btn btn-primary btn-lg btn" type="submit" name="update" id="update" value="Salvar Alterações">	
					</div>
				</form>
			</div>
		</div>
