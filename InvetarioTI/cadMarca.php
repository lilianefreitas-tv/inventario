<?php
	...
	if (isset($_POST['submit']))
	{
		...
		$result = mysqli_query($conexao, "INSERT INTO marca (id_marca,descricao) VALUES (null,'{$descricao}')");
	...
	<body class="bg-light">
        ...
        <div class=" container col-md-6 order-md-1" >
			<div class="py-3 text-left">
				<form class="needs-validation" novalidate action="cadMarca.php" method="POST" >
					<div class="row">
