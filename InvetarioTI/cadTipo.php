<?php
	...
	if (isset($_POST['submit']))
	{
		...
		$result = mysqli_query($conexao, "INSERT INTO tipo (id_tipo,descricao) VALUES (null,'{$descricao}')");
	...
	<body class="bg-light">
		<div class="container">
			<div class="py-4 text-center">
				<br> <br>
				<h2>Cadastro de Tipos de Material</h2>
			</div>
		</div>
        <div class=" container col-md-6 order-md-1" >
			<div class="py-3 text-left">
				<form class="needs-validation" novalidate action="cadTipo.php" method="POST" >
					<div class="row">
