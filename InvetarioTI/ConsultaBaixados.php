<?php
    ...
    if (!empty($_GET['search'])) {
		...
		$sql = "SELECT * FROM material  WHERE status IN ('inativo') ORDER BY data DESC";
	}
...
<html lang="pt-br">
	...
	<body>
		...
		<h3 align="center">Consulta de Baixa de Patrimônios</h3>
					...
					<div class="printable">
						<?php
							...
							while ($user_data = mysqli_fetch_assoc($result)) { 
								...
								<a class='btn btn-sm btn-success' href='ativaInventario.php?id=$user_data[id_material]' title='Ativar Patrimônio'>
