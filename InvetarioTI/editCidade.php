	...
	<body class="bg-light">
		...
		<div class=" container col-md-6 order-md-1">
			<div class="py-3 text-left">
				<form class="needs-validation" novalidate action="saveEditCidade.php" method="POST" >
					<div class="row">
						<div class="col-md-2 mb-3">
							<label for="codigo">Código</label>
							<input type="text" class="form-control" name= "codigo" id="codigo" placeholder="" value="<?php echo $id_cidade ?>" required readonly>
